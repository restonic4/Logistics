...
import com.restonic4.logistics.blocks.computer.screen.triggers.editors.types.RedstoneTriggerEditor;
...
public final class TriggerEditors {
    ...
    static {
        ...
        register(TriggerRegistry.REDSTONE, new RedstoneTriggerEditor());
    }
